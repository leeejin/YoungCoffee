...
class Numbering extends Component {
    ...
    render() {
        return (
            <button onClick={() => this.props.clickListener(this.props.page)} style={this.props.page == this.props.currentPage ? { color: 'white',background:'#002572',borderRadius:0 } : { color: 'black',borderRadius:0  }}>
                {this.props.page}
            </button>
        );
    }
